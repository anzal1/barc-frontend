...
export const loginUser = ({ User_Name, Password }: LoginBody): Promise<unknown> =>
	apiClient('/api/login/CheckUsercredentials?User_Name=' + User_Name + '&Password=' + Password, {
		method: 'POST'
	})

export const createJWT = ({ User_Name, Password }: LoginBody): Promise<unknown> =>
	apiClient('/api/login/JWTToken?Username=' + User_Name + '&Password=' + Password, {
		method: 'POST'
	})
...
export const createOrEditDeviceMaster = (body: {
	...
	apiClient(body.isEdit ? '/api/Device/UpdateDeviceEntry' : '/api/Device/InsertDeviceEntry', {
		method: 'POST',
...
export const createOrEditEmployeeMaster = (body: {
	...
	return apiClient(
		body.isEdit ? '/api/Employee/UpdateEmployeeDetails' : '/api/Employee/InsertEmployeeEntry',
...
export const downloadReports = (params: Omit<getReportBody, 'pageNumber'>): Promise<unknown> =>
	apiClient(
...
export const insertAcknowledgement = (body: InsertAcknowledgeBody): Promise<unknown> =>
